...
# v0.9.0 — Metrics Expansion • Ingest Fixes • CLI Stability • CI Cleanup • CPU Profiling Infrastructure

**Release date:** 2025-12-03

This release finalizes the pre-1.0 groundwork:
✔ advanced trading metrics,
✔ consistent data ingestion model,
✔ stable CLI behavior,
✔ profiling tools,
✔ cleanup of tests and configuration system.

CI is intentionally **not** fixed in this milestone — full CI refactor is scheduled for **v1.0.5**.
...
- `perf_setup.sh` — automatic perf environment setup
- `perf_flamegraph.sh` — FlameGraph generator
- `perf_hotspot.sh` — hotspot extraction
...
(Windows CI still fails — by design — due to postponed path unification.)
...
# Planned for 1.0.5 — *Advanced Test Infrastructure*
