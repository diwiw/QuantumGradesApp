...
namespace qga::core
{
    ...
    Grades::Grades()
    {
        logger_ = ::qga::utils::LoggerFactory::createLogger("GradesDemo", "logs/grades_demo.log",
                                                            qga::LogLevel::Info);
    }
    ...
    float Grades::getMean() const
    {
        if (notes_.empty())
        {
            logger_->log(qga::LogLevel::Warn,
                         "[Grades] Attempted to calculate mean with empty list");
            return 0.0f;
        }
        ...
        {
            logger_->log(qga::LogLevel::Info,
                         fmt::format("[Grades] Calculated mean: {}", mean_opt.value()));
    ...
    float Grades::getMedian() const
    {
        ...
        {
            logger_->log(qga::LogLevel::Warn,
                         "[Grades] Attempted to calculate median with empty list");
            return 0.0f;
        }
        ...
        {
            logger_->log(qga::LogLevel::Info,
                         fmt::format("[Grades] Calculated median: {}", median_opt.value()));
    ...
    float Grades::getStdDev() const
    {
        ...
        {
            logger_->log(qga::LogLevel::Info,
                         fmt::format("[Grades] Calculated stddev: {}", stddev_opt.value()));
    ...
    int Grades::getMax() const
    {
        ...
        {
            logger_->log(qga::LogLevel::Warn,
                         "[Grades] Attempted to calculate max with empty list");
            return 0;
        }
        ...
        {
            logger_->log(qga::LogLevel::Info,
                         fmt::format("[Grades] Max grade: {}", max_opt.value()));
    ...
    int Grades::getMin() const
    {
        ...
        {
            logger_->log(qga::LogLevel::Warn,
                         "[Grades] Attempted to calculate min with empty list");
            return 0;
        }
        ...
        {
            logger_->log(qga::LogLevel::Info,
                         fmt::format("[Grades] Min grade: {}", min_opt.value()));
